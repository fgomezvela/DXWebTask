...
// task Add in test for making sure all pres get called if pre is defined directly on an instance.
// task Test for calling `done` twice or `next` twice in the same function counts only once
module.exports = {
